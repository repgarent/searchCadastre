...
#
# Created: Fri Jan 16 16:10:47 2015
...
class Ui_simple_cadastre_search_form(object):
    def setupUi(self, simple_cadastre_search_form):
        ...
        self.btCentrer = QtGui.QPushButton(self.grpLieu)
        self.btCentrer.setText(_fromUtf8(""))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/cadastre/icons/centrer.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btCentrer.setIcon(icon)
        self.btCentrer.setObjectName(_fromUtf8("btCentrer"))
        self.horizontalLayout_3.addWidget(self.btCentrer)
        self.btZoomer = QtGui.QPushButton(self.grpLieu)
        self.btZoomer.setText(_fromUtf8(""))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/cadastre/icons/zoom.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btZoomer.setIcon(icon1)
        self.btZoomer.setObjectName(_fromUtf8("btZoomer"))
        self.horizontalLayout_3.addWidget(self.btZoomer)
        self.btSelectionner = QtGui.QPushButton(self.grpLieu)
        self.btSelectionner.setText(_fromUtf8(""))
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(_fromUtf8(":/plugins/cadastre/icons/select.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btSelectionner.setIcon(icon2)
        self.btSelectionner.setObjectName(_fromUtf8("btSelectionner"))
        self.horizontalLayout_3.addWidget(self.btSelectionner)
    ...
    def retranslateUi(self, simple_cadastre_search_form):
        ...
        self.btCentrer.setToolTip(_translate("simple_cadastre_search_form", "Centrer sur l\'objet", None))
        self.btZoomer.setToolTip(_translate("simple_cadastre_search_form", "Zoomer sur l\'objet", None))
        self.btSelectionner.setToolTip(_translate("simple_cadastre_search_form", "Sélectionner l\'objet", None))
